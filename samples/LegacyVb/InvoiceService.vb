...
' Idiomatic VB: no explicit Namespace block — the type lives under the project's RootNamespace
' ("LegacyVb"), the way most real VB codebases are organized. This also exercises Pinion's
' RootNamespace handling: the compiled type is LegacyVb.InvoiceService.
